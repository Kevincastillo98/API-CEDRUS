...
datos_covid =  pd.read_csv('~/Documentos/API-CEDRUS/Proyecto/Datos/datos_covid_19.csv',encoding='latin1',index_col=0)
...
datos = datos_covid_geopoint.to_csv("~/Documentos/API-CEDRUS/Proyecto/Datos/datos_covid_geo.csv")
